...
<body>
    ...
    <div class="container">
    <div class="wrapper">
        <marquee behavior="scroll"><span class="marquee">Welcome To Electronics Shopping If Interested For Buy Then Contact Supplier </span></marquee>
    </div>
    </div>
  ...
  <div class="col-md-4">
    ...
    <div class="card-header">
            <img src="<?php echo $row['image']; ?>" class="card-img-top custom-card-img" alt="Product Image">
        </div>
        <div class="card-body">
    ...
    <a href=product_details_page/e_product_details.php?id=<?php echo $row['id']; ?> style="text-decoration: none; color: white;">Explore Supplier</a>
</button>
