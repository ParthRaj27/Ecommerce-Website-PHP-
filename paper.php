...
<body>
    ...
    <div class="container">
    <div class="wrapper">
        <marquee behavior="scroll"><span class="marquee">Welcome To Paper Scrap Shopping If Interested For Buy Then Contact Supplier </span></marquee>
    </div>
    </div>
  ...
  <div class="col-md-4">
    ...
    <a href="product_details_page/pa_product_details.php?id=<?php echo $row['id']; ?>" style="text-decoration: none; color: white;">Explore Supplier</a>
</button>
