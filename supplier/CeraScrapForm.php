...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CeraScrap (supplier_id, productName, pricePerKg, color, source, thickness, packagingSize, material, minOrderQuantity, image) 
...
<body class="sb-nav-fixed">
    ...
    <h2 class="mb-4">Ceramics Scrap Form</h2>
    <form action="CeraScrapForm.php" method="post" enctype="multipart/form-data">
        <div class="row">
