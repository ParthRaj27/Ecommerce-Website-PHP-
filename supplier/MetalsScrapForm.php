...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `metalscrap` (`supplier_id`, `productName`, `pricePerKg`, `color`, `source`, `thickness`, `packagingSize`, `material`, `minOrderQuantity`, `image`)  
...
<body class="sb-nav-fixed">
    ...
    <h2 class="mb-4">metals Scrap Form</h2>
    <form action="MetalsScrapForm.php" method="post" enctype="multipart/form-data">
        <div class="row">
