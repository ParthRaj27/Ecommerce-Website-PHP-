...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ElectroScrap (supplier_id, productName, pricePerKg, color, source, thickness, packagingSize, material, minOrderQuantity, image) 
...
<body class="sb-nav-fixed">
    ...
    <h2 class="mb-4">Electronics Scrap Form</h2>
    <form action="ElectroScrapForm.php" method="post" enctype="multipart/form-data">
        <div class="row">
