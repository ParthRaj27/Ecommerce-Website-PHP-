...
<body>
  ...
  <div class="col-md-4">
    ...
    <a href="product_details_page/c_product_details.php?id=<?php echo $row['id']; ?>" style="text-decoration: none; color: white;">Explore Supplier</a>
</button>
