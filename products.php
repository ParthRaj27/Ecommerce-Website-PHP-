...
<body>
    ...
    <div class="container">
    <div class="wrapper">
        <marquee behavior="scroll"><span class="marquee">Welcome To Ceramic Shopping If Interested For Buy Then Contact Supplier </span></marquee>
    </div>
    </div>
...
<div class="col-md-4">
    <div class="card custom-card">
        <div class="card-header">
            <img src="<?php echo $row['product_image_path']; ?>" class="card-img-top custom-card-img" alt="Product Image">
        </div>
        <div class="card-body">
            <h5 class="card-title"><?php echo $row['product_name']; ?></h5>
            <ul class="list-group">
                <li class="list-group-item"><strong>Industry:</strong> <?php echo $row['industry']; ?></li>
                <li class="list-group-item"><strong>City:</strong> <?php echo $row['city']; ?></li>
                <li class="list-group-item"><strong>Min Order Quantity:</strong> <?php echo $row['min_order_quantity']; ?></li>
                <li class="list-group-item"><strong>Scrap Source:</strong> <?php echo $row['scrap_source']; ?></li>
                <li class="list-group-item"><strong>Packaging Size:</strong> <?php echo $row['packaging_size']; ?></li>
                ...
                <li class="list-group-item"><strong>Delivery By:</strong> <?php echo $row['delivery_by']; ?></li>
                <li class="list-group-item"><strong>Other Details:</strong> <?php echo $row['other_details']; ?></li>
            </ul>
            <!-- <button class="custom-button">
                <a href="product_details_page/g_product_details.php?id=<?php echo $row['id']; ?>" style="text-decoration: none; color: white;">Explore Supplier</a>
            </button> -->
        </div>
    </div>
</div>
